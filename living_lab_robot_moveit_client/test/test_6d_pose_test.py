...
#   w = 0.7217915429529475
    ...
    goal.target_pose.pose.position.x = 0.6296955187676937
    goal.target_pose.pose.position.y = -0.05200468500251687
    goal.target_pose.pose.position.z = 0.785308724473028

    goal.target_pose.pose.orientation.x = 0.25194559919970655
    goal.target_pose.pose.orientation.y = 0.2727012140252847
    goal.target_pose.pose.orientation.z = -0.5930299651383254
    goal.target_pose.pose.orientation.w = 0.7144738787115126
