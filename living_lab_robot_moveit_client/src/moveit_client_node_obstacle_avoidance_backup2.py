...
class MoveitClientNode:
	...
	box_pose.pose.position.x = 0.9 # slightly above the end effector
	box_pose.pose.position.y = 0.0 # slightly above the end effector
	box_pose.pose.position.z = 0.385 # slightly above the end effector
	box_name = "table"
	self.scene.add_box(box_name, box_pose, size=(0.45, 1.23, 0.77))
